...
<label class ="blue-text text-darken-2" for="nom de la marques">Nom de la marque</label>
    <input type="text" class="form-control" name="designationfamille" v-model="nommarque" placeholder="nom de le marque">
    ...
    <b-form-file v-on:change="afficheimageselect" v-model="fichierimage" accept=".jpg, .png, .gif"
            placeholder="Choisissez la photo pour désigner la marque" >
    </b-form-file>
...
export default {
  ...
  data () {
    return {
      titrepages: "Gestion des Marques",
        limitA: 0,
         LimitLignePage: 10,
        nombreligne:[
         {a : 10, value:"10"  },
...
axios.get(this.cheminUrl+this.ApiGroupeClient+'afficheListeMarque').then(response => {
